...
precompile(adam_step_decay!,(quasiGrad.QG, Float64, Float64, Float64, Bool))
...
precompile(cleanup_constrained_pf_with_Gurobi!,(quasiGrad.Index, quasiGrad.Network, quasiGrad.Param, quasiGrad.QG,  quasiGrad.State, quasiGrad.System))
...
precompile(run_adam_pf!,(quasiGrad.Adam, quasiGrad.ConstantGrad, quasiGrad.Contingency, quasiGrad.Flow, quasiGrad.Grad, quasiGrad.Index, quasiGrad.MasterGrad, quasiGrad.Network, quasiGrad.Param, quasiGrad.QG, Dict{Symbol, Float64}, quasiGrad.State, quasiGrad.System, Dict{Symbol, Vector{Vector{Int64}}}))
...
precompile(solve_parallel_linear_pf_with_Gurobi!,(quasiGrad.Index, quasiGrad.Network, quasiGrad.Param, quasiGrad.QG,  quasiGrad.State, quasiGrad.System, Bool))
...
precompile(update_states_and_grads_for_adam_pf!,(quasiGrad.Grad, quasiGrad.Index, quasiGrad.MasterGrad, quasiGrad.Param, quasiGrad.QG, quasiGrad.State, quasiGrad.System))
