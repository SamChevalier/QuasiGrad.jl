function solve_ctgs!(
    ...
    # this script solves AND scores AND differentiates
    #
    # ===========================
...
function lowrank_update_single_ctg_gradient!(ctd::Vector{Vector{Float64}}, ctg_ii::Int64, flw::quasiGrad.Flow, ntk::quasiGrad.Network, qG::quasiGrad.QG, sys::quasiGrad.System, tii::Int8)
...
function zctgs_grad_qfr_acline!(aclfr_alpha::Vector{Float64}, bit::quasiGrad.Bit, grd::quasiGrad.Grad, idx::quasiGrad.Index, mgd::quasiGrad.MasterGrad, prm::quasiGrad.Param, qG::quasiGrad.QG, sys::quasiGrad.System, tii::Int8)
...
function zctgs_grad_qto_acline!(aclto_alpha::Vector{Float64}, bit::quasiGrad.Bit, grd::quasiGrad.Grad, idx::quasiGrad.Index, mgd::quasiGrad.MasterGrad, prm::quasiGrad.Param, qG::quasiGrad.QG, sys::quasiGrad.System, tii::Int8)
    # so, this function takes and applies the gradient of
    # zctgs (at acline) with repsect to reactive power
    # variables (i.e., all variables on a line which affect
    # reactive power flows).
...
function zctgs_grad_qfr_xfm!(bit::quasiGrad.Bit, grd::quasiGrad.Grad, idx::quasiGrad.Index, mgd::quasiGrad.MasterGrad, prm::quasiGrad.Param, qG::quasiGrad.QG, sys::quasiGrad.System, tii::Int8, xfr_alpha::Vector{Float64})
    # so, this function takes and applies the gradient of
...
function zctgs_grad_qto_xfm!(bit::quasiGrad.Bit, grd::quasiGrad.Grad, idx::quasiGrad.Index, mgd::quasiGrad.MasterGrad, prm::quasiGrad.Param, qG::quasiGrad.QG, sys::quasiGrad.System, tii::Int8, xto_alpha::Vector{Float64})
    # so, this function takes and applies the gradient of
    # zctgs (at transformers) with repsect to reactive power
    # variables (i.e., all variables on a line which affect
    # reactive power flows).
...
function zctgs_grad_pinj!(alpha::Vector{Float64}, grd::quasiGrad.Grad, idx::quasiGrad.Index, mgd::quasiGrad.MasterGrad, ntk::quasiGrad.Network, prm::quasiGrad.Param, sys::quasiGrad.System, tii::Int8)
