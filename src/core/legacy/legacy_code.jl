...
# test if this contingency has the new smallest score
        ...
        qG = Dict(
            ...
            :pqbal_grad_mod_type     => "soft_abs", # "standard"
            :pqbal_grad_mod_weight_p => 10.0, # standard: prm.vio.p_bus
            :pqbal_grad_mod_weight_q => 10.0, # standard: prm.vio.q_bus
            :pqbal_grad_mod_eps2     => 1e-5,
            )
